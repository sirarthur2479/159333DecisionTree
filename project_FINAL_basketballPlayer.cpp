...
int main(){
    ...
    Dataset dsTest;
	FeatureSet fs;
	char  training_dataset_input_file[50] = "basketall_training_dataset.txt";
	char  testing_dataset_input_file[50] = "basketall_training_dataset.txt";
   ...
   fs.printFeatureSet();
	...
	AccuracyTree(root, dsTraining, fs, 0);//working
}